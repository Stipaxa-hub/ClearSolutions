...
public class UserController {
    ...
    @PatchMapping("/{id}")
    public UserResponseDto updatePartially(@PathVariable Long id, @RequestBody UserRequestDto userRequestDto) {
        return userService.updatePartially(id, userRequestDto);
    }
